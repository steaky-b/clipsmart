...
const CAMPAIGNS = [
  ...
  },
  {
    ...
    direction: 'Children\'s clothing brand running a performance UGC campaign. Creators were briefed to feature Leveret\'s colourful, everyday clothing naturally inside family lifestyle, parenting, and kids\' content — letting the product speak for itself without forced promotion.',
    outcome: '4.3M+ total views across 184 UGC posts, with 87% of the audience based in the USA. Nine individual posts exceeded 100K views. 227K+ recorded engagements (likes, comments, shares). Booked at $1 CPM, the campaign over-delivered and landed an effective CPM of $0.76.',
    results: [
    ...
    highlight: '4.3M+ views · 184 UGC posts · 87% US audience · $0.76 effective CPM.',
    img: '/cs-leveret.png',
