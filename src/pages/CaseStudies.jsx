...
const CAMPAIGNS = [
  ...
  },
  {
    ...
    direction: 'Children\'s clothing brand running a performance UGC campaign across TikTok and Instagram. Creators were briefed to feature Leveret\'s colourful, everyday essentials naturally inside family, lifestyle, and back-to-school content — putting the brand in front of parents at the exact moment they\'re shopping for their kids.',
    outcome: '4.3M+ total views in 16 hours. 184 UGC posts live, with 9 breaking 100K views individually. 87% of the audience was US-based. 227K+ recorded engagements (likes, comments, shares). Booked at $1 CPM — over-delivered and landed at $0.76 effective CPM.',
    results: [
      ...
      { v: '87%', l: 'US audience' },
      { v: '9', l: 'Posts over 100K views' },
    ],
    highlight: '4.3M+ views in 16 hours. $0.76 effective CPM — 24% below the booked rate.',
    img: '/cs-leveret.png',
